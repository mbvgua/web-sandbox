...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"static/dist/login.js":[function(require,module,exports) {
var define;
"use strict";
...
var loginUser = /*#__PURE__*/function () {
  ...
  return _createClass(loginUser, [{
    ...
    key: "setError",
    value: function setError(element, message) {
      var inputControll = element.parentElement;
      var displayError = inputControll.querySelector('.error');
    ...
    value: function validateCredentials() {
      return __awaiter(this, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        var emailVal, passwordVal, userInfo, response, users, validUser;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 12:
              ...
              if (users.length > 0) {
                ...
                if (validUser.email == 'admin@gmail.com' || validUser.priviledges == 'admin') {
                  ...
                  responseDiv.innerHTML = "<label> Welcome ".concat(validUser.username, "! </label>");
                  setTimeout(function () {
                  ...
                  responseDiv.style.display = 'flex';
                  responseDiv.style.visibility = 'visible';
                  responseDiv.innerHTML = "<label> Welcome back,".concat(validUser.username, "! </label>");
                  setTimeout(function () {
            ...
            case 16:
              ...
              console.error("Failed to login user into due to database: ".concat(_context.t0));
            case 19:
              _context.next = 22;
              break;
            case 21:
...
var loginUserInstance = new loginUser();
...
},{}]},{},["../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","static/dist/login.js"], null)
//# sourceMappingURL=/login.953d04a3.js.map